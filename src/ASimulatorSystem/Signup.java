    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            if(name.equals("") || fname.equals("") || dob.equals("") || gender == null || 
               email.equals("") || marital == null || address.equals("") || 
            ...
            String createTable = "CREATE TABLE IF NOT EXISTS signup (" +
                               "formno varchar(20), " +
                               "name varchar(20), " +
                               "fname varchar(20), " +
                               "dob varchar(20), " +
                               ...
                               "pincode varchar(20), " +
                               "state varchar(25))";
            c1.s.executeUpdate(createTable);
            System.out.println("Table verified/created successfully");
            
            String q1 = "INSERT INTO signup (formno, name, fname, dob, gender, email, marital, address, city, pincode, state) " +
            ...
            System.out.println("Error in form submission: " + e.getMessage());
            e.printStackTrace();
