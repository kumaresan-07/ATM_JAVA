...
public class Signup3 extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        // Generate a 16-digit card number starting with 4 (for testing)
        long first7 = Math.abs((ran.nextLong() % 90000000L) + 5040936000000000L);
        String cardno = String.format("%016d", first7).substring(0, 16);
        
        // Generate a 4-digit PIN
        String pin = String.format("%04d", 1000 + ran.nextInt(9000));
        System.out.println("Generated PIN: " + pin); // Debug log
        ...
        try{
            if(ae.getSource()==b1){
                ...
                if(atype == null){
                    ...
                    try {
                        c1.s.executeUpdate("DROP TABLE IF EXISTS signup3");
                        c1.s.executeUpdate("DROP TABLE IF EXISTS login");
                    } catch (SQLException e) {
                        System.out.println("Warning: Could not drop existing tables: " + e.getMessage());
                    }
                    ...
                    c1.s.executeUpdate("CREATE TABLE IF NOT EXISTS signup3 (" +
                        "formno varchar(20), " +
                    ...
                    c1.s.executeUpdate("CREATE TABLE IF NOT EXISTS login (" +
                        "formno varchar(20), " +
                        "cardnumber varchar(16), " +
                        "pin varchar(4))");
