...
public class Signup2 extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            // Validate PAN format (assuming ABCDE1234F format)
            if(!pan.matches("[A-Z]{5}[0-9]{4}[A-Z]{1}")){
                JOptionPane.showMessageDialog(null, "Please enter a valid PAN number (Format: ABCDE1234F)");
                return;
            }
            ...
            String createTable = "CREATE TABLE IF NOT EXISTS signup2 (" +
                               "formno varchar(20), " +
                               "religion varchar(20), " +
                               "category varchar(20), " +
                               "income varchar(20), " +
            ...
            System.out.println("Error in form submission: " + ex.getMessage());
            ex.printStackTrace();
